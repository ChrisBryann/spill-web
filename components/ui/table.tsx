...
>(({ className, ...props }, ref) => (
   <thead ref={ref} className={ny('[&_tr]:border-b sticky top-0', className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
   <tfoot
      ref={ref}
      className={ny(
         'bg-muted/50 border-t font-medium [&>tr]:last:border-b-0 sticky bottom-0',
         className,
      )}
      {...props}
   />
...
>(({ className, ...props }, ref) => (
   <th
      ref={ref}
      className={ny(
         'text-muted-foreground h-12 px-4 text-left align-middle font-medium [&:has([role=checkbox])]:pr-0 sticky top-0',
         className,
      )}
      {...props}
   />
